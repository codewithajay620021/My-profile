...
if(isset($_POST['save']))
{
    ...
    if($pass)
    {
        $data = "SELECT * FROM `stu_login` WHERE Email = '$uname'";
        ...
        if($result > 0)
        {
            ...
            $insert = "INSERT INTO `stu_login`(`Email`, `Pass`, `Cpass`) VALUES ('$uname','$pass','$cpass')";
...
<head>
    ...
    <link rel="stylesheet" href="Stusing.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
</head>
<body> 
    <button class="btnn"><a href="login.php">Home</a></button>
    <div class="container">
        <h1>Student Sing-Up</h1>
        <div class="form">
            <img src="log-img/graduate.png" alt="" width="200px">
